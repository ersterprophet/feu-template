...
Quickstart
------------
In der Datei "feu-template.tex" den Abschnitt zwischen **START OF PARAMETERS** und **END OF PARAMETERS** sowie die Punkte-Matrix
...
* Datum
* Parameter allgemein in simple Textdatei auslagern und per Präprozessor einbauen
